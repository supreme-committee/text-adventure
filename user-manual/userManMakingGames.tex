...
In addition, there is a special application of variables inside of text tags. You can use {{ }} with the name of a variable inside, and the value of that variable will be displayed. 
